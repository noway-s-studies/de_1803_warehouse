...
public class HomeModel implements AutoCloseable {
    ...
    public String getSumValue() {
        ...
        try {
            Query query = entityManager.createNativeQuery(
                    "SELECT CAST(sum(UnitPrice.price*Stock.quantity*(CAST(((100-Purveyor.discount))AS DECIMAL(30,2))/100))AS DECIMAL(30,0)) " +
        ...
        String stringValue = value > 10000000 ? "Több mint 10 Millió Forint" : String.valueOf(value) + " Ft.";
        return stringValue;
    }
     ...
     *
     * @return telephelyek közötti rakrárkészlet megoszlás
     */
